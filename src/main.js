...
const renderHtmlElement = (container, element, position) => {
...
const createEventFormDestinationTemplate = () => {
  return (`
...
// render elems
renderHtmlElement(tripInfo, createTripInfoTemplate(), `beforeend`);
renderHtmlElement(tripInfo, createTripCostTemplate(), `beforeend`);
